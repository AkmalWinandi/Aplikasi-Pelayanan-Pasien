    ...
    ?>
        <div class="bg-light p-3 mb-3">
            <div class="container">
                <div class="row ">
                    <div class="col ">
                        <h4 class="record-title">View Surat Keterangan Sehat</h4>
                    </div>
                </div>
            </div>
        </div>
                            ...
                            <div id="page-report-body" class="">
                                <table class="table table-hover table-borderless table-striped">
                                    ...
                                    <tbody class="page-data" id="page-data-<?php echo $page_element_id; ?>">
                                        ...
                                        <tr class="td-pangkat_gol">
                                            <th class="title"><i class="icon-graduation "></i> Pangkat Gol </th>
                                            <td class="value"> : <?php echo $data['pangkat_gol']; ?></td>
                                        </tr>
                                        <tr class="td-jabatan">
                                        ...
                                        <tr class="td-umur">
                                            <th class="title"><i class="icon-hourglass "></i> Umur </th>
                                        ...
                                        <tr class="td-alamat_pasien">
                                            <th class="title"><i class="icon-location-pin "></i> Alamat Pasien </th>
                                            <td class="value"> :<?php echo $data['alamat_pasien']; ?></td>
                                        </tr>
                                        <tr class="td-keperluan">
                                            <th class="title"><i class="icon-speech "></i> Keperluan </th>
                                            <td class="value"> :<?php echo $data['keperluan']; ?></td>
                                        </tr>
                                        <tr class="td-tinggi_badan">
                                            <th class="title"><i class="icon-calculator "></i> Tinggi Badan </th>
                                            <td class="value"> :<?php echo $data['tinggi_badan']; ?></td>
                                        </tr>
                                        <tr class="td-berat_badan">
                                            <th class="title"><i class="icon-calculator "></i> Berat Badan </th>
                                            <td class="value"> :<?php echo $data['berat_badan']; ?></td>
                                        </tr>
                                        <tr class="td-tekanan_darah">
                                            <th class="title"><i class="icon-chemistry "></i> Tekanan Darah </th>
                                            <td class="value"> :<?php echo $data['tekanan_darah']; ?></td>
                                        </tr>
                                        <tr class="td-golongan_darah">
                                            <th class="title"><i class="icon-heart "></i> Golongan Darah </th>
