    ...
    ?>
        <div class="bg-light p-3 mb-3">
            <div class="container">
                <div class="row ">
                    <div class="col ">
                        <h4 class="record-title">Tambah Surat Keterangan Sehat</h4>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row ">
                <div class="col-md-7 comp-grid">
                    ...
                    <div class="bg-light p-3 animated fadeIn page-content">
                        <form id="surat_keterangan_sehat-add-form" role="form" novalidate enctype="multipart/form-data" class="form page-form form-horizontal needs-validation" action="<?php print_link("surat_keterangan_sehat/add?csrf_token=$csrf_token") ?>" method="post">
                            <div>
                                ...
                                <div class="form-group ">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-8">
                                            <div class="">
                                                <input id="ctrl-pangkat_gol" value="<?php echo $this->set_field_value('pangkat_gol', ""); ?>" type="text" placeholder="Enter Pangkat Gol" required="" name="pangkat_gol" class="form-control " />
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="form-group ">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-8">
                                            <div class="">
                                                <textarea placeholder="Enter Alamat Dokter" id="ctrl-alamat_dokter" required="" rows="5" name="alamat_dokter" class=" form-control"><?php echo $this->set_field_value('alamat_dokter', ""); ?></textarea>
                                ...
                                <div class="form-group ">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-8">
                                            <div class="">
                                                <textarea placeholder="Enter Alamat Pasien" id="ctrl-alamat_pasien" required="" rows="5" name="alamat_pasien" class=" form-control"><?php echo $this->set_field_value('alamat_pasien', ""); ?></textarea>
                                                <!--<div class="invalid-feedback animated bounceIn text-center">Please enter text</div>-->
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="form-group ">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-8">
                                            <div class="">
                                                <textarea placeholder="Enter Keperluan" id="ctrl-keperluan" required="" rows="5" name="keperluan" class=" form-control"><?php echo $this->set_field_value('keperluan', ""); ?></textarea>
                                                <!--<div class="invalid-feedback animated bounceIn text-center">Please enter text</div>-->
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="form-group ">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-8">
                                            <div class="">
                                                <input id="ctrl-tinggi_badan" value="<?php echo $this->set_field_value('tinggi_badan', ""); ?>" type="text" placeholder="Enter Tinggi Badan" required="" name="tinggi_badan" class="form-control " />
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="form-group ">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-8">
                                            <div class="">
                                                <input id="ctrl-tekanan_darah" value="<?php echo $this->set_field_value('tekanan_darah', ""); ?>" type="text" placeholder="Enter Tekanan Darah" required="" name="tekanan_darah" class="form-control " />
                                            </div>
                                        </div>
                                    </div>
                                </div>
