    ...
    ?>
        <div class="bg-light p-3 mb-3">
            <div class="container">
                <div class="row ">
                    <div class="col ">
                        <h4 class="record-title">Tambah Surat Keterangan Sakit</h4>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row ">
                <div class="col-md-7 comp-grid">
                    ...
                    <div class="bg-light p-3 animated fadeIn page-content">
                        <form id="surat_keterangan_sakit-add-form" role="form" novalidate enctype="multipart/form-data" class="form page-form form-horizontal needs-validation" action="<?php print_link("surat_keterangan_sakit/add?csrf_token=$csrf_token") ?>" method="post">
                            <div>
                                ...
                                <div class="form-group ">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-8">
                                            <div class="">
                                                <input id="ctrl-alamat_dokter" value="<?php echo $this->set_field_value('alamat_dokter', ""); ?>" type="text" placeholder="Enter Alamat Dokter" required="" name="alamat_dokter" class="form-control " />
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="form-group ">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-8">
                                            <div class="">
                                                <input id="ctrl-alamat_pasien" value="<?php echo $this->set_field_value('alamat_pasien', ""); ?>" type="text" placeholder="Enter Alamat Pasien" required="" name="alamat_pasien" class="form-control " />
                                            </div>
                                        </div>
                                    </div>
                                </div>
