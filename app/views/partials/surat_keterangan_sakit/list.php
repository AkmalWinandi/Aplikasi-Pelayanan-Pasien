        ...
        <div class="bg-light p-3 mb-3">
            <div class="container-fluid">
                <div class="row ">
                    <div class="col ">
                        <form method="get" action="<?php print_link($current_page) ?>" class="form filter-form">
                            <div class="card mb-3">
                                ...
                                <div class="p-2">
                                    <input class="form-control datepicker" value="<?php echo $this->set_field_value('surat_keterangan_sakit_tanggal') ?>" type="datetime" name="surat_keterangan_sakit_tanggal" placeholder="" data-enable-time="" data-date-format="Y-m-d" data-alt-format="M j, Y" data-inline="false" data-no-calendar="false" data-mode="range" />
                                </div>
                            </div>
                            <hr />
                    ...
                    <div class="col-sm-3 ">
                        <a class="btn btn btn-primary my-1" href="<?php print_link("surat_keterangan_sakit/add") ?>">
                            <i class="icon-plus"></i>
                            Tambah Surat Sakit
                        </a>
                    </div>
                    <div class="col-sm-4 ">
                        <form class="search" action="<?php print_link('surat_keterangan_sakit'); ?>" method="get">
                                    ...
                                    <ul class="breadcrumb m-0 p-1">
                                        ...
                                        ?>
                                            <li class="breadcrumb-item">
                                                <a class="text-decoration-none" href="<?php print_link('surat_keterangan_sakit'); ?>">
            ...
            <div class="row ">
                <div class="col-md-12 comp-grid">
                    ...
                    <div class="filter-tags mb-2">
                        <?php
                        if (!empty($_GET['surat_keterangan_sakit_tanggal'])) {
                        ?>
                            <div class="filter-chip card bg-light">
                                <b>Surat Keterangan Sakit Tanggal :</b>
                                <?php
                                $date_val = get_value('surat_keterangan_sakit_tanggal');
                                $formated_date = "";
                                ...
                                echo  $formated_date;
                                $remove_link = unset_get_value('surat_keterangan_sakit_tanggal', $this->route->page_url);
                                ?>
                    ...
                    <div class=" animated fadeIn page-content">
                        <div id="surat_keterangan_sakit-list-records">
                                        ...
                                        <tbody class="page-data" id="page-data-<?php echo $page_element_id; ?>">
                                            ...
                                            ?>
                                                <tr>
                                                    ...
                                                    <th class="td-btn">
                                                        <a class="btn btn-sm btn-success has-tooltip" title="View Record" href="<?php print_link("surat_keterangan_sakit/view/$rec_id"); ?>">
                                                            <i class="icon-eye"></i>
                                                        </a>
                                                        <a class="btn btn-sm btn-info has-tooltip" title="Edit This Record" href="<?php print_link("surat_keterangan_sakit/edit/$rec_id"); ?>">
                                                            <i class="icon-pencil"></i>
                                                        </a>
                                                        <a class="btn btn-sm btn-danger has-tooltip record-delete-btn" title="Delete this record" href="<?php print_link("surat_keterangan_sakit/delete/$rec_id/?csrf_token=$csrf_token&redirect=$current_page"); ?>" data-prompt-msg="Are you sure you want to delete this record?" data-display-style="modal">
                                    ...
                                    <div class="row justify-content-center">
                                        <div class="col-md-auto justify-content-center">
                                            <div class="p-3 d-flex justify-content-between">
                                                <button data-prompt-msg="Are you sure you want to delete these records?" data-display-style="modal" data-url="<?php print_link("surat_keterangan_sakit/delete/{sel_ids}/?csrf_token=$csrf_token&redirect=$current_page"); ?>" class="btn btn-sm btn-danger btn-delete-selected d-none">
