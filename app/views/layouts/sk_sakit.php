...
<body>
  ...
  <p class="pp1">Dengan ini menyatakan bahwa :</p>
  <div class="mrd">
    <table class="table table-hover table-borderless table-striped">
      <!-- Table Body Start -->
      <tr>
        <th class="we">Nama Pasien </th>
        <td> : <b><?php echo $data['nama_pasien']; ?></b></td>
      </tr>
      <tr>
        <th> Nik </th>
  ...
  <p class="pp1"> <?php echo $data['keterangan']; ?></p><br>

  <p class="pp1">Demikian surat keterangan ini dibuat untuk dapat dipergunakan sebagaimana mestinya.</p>
  <div class="mrd4">
    <table class="table table-hover table-borderless table-striped">
      <tr>
